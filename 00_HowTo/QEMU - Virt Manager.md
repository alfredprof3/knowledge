...
```
- Download ISO using `wget` or `curl`
```bash
curl -L -O https://iso.pop-os.org/24.04/amd64/generic/27/pop-os_24.04_amd64_generic_27.iso
```
```bash
wget https://iso.pop-os.org/24.04/amd64/generic/27/pop-os_24.04_amd64_generic_27.iso
```
